    ...
    return Column(children: [
      SingleChildScrollView(
        child: GridView.builder(
          ...
          shrinkWrap: true, // This makes the GridView.builder take only as much space as it needs
      ...
      ElevatedButton(
        onPressed: clearBoard, // Call the clearBoard method when the button is pressed
